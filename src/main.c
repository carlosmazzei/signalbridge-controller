...
/**
 * Header size (Id, Id + Command, lenght)
 */
#define HEADER_SIZE 3

/**
 * Checksum size (last byte of the message)
 */
#define CHECKSUM_SIZE 1

/**
 * Maximum size of the reception buffer
 */
#define MAX_BUFFER_SIZE (HEADER_SIZE + DATA_BUFFER_SIZE + CHECKSUM_SIZE)

/**
 * Maximum size of the cobs encoded reception buffer
 * Calculation: input_lenght + n/254 + Packet Marker
 */

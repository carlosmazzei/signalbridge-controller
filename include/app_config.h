...
/**
 * @brief Maximum number of consecutive full CDC RX reads before yielding.
 *
 * This bounds one @ref uart_event_task service quantum to 2 KiB with the
 * current @ref CDC_READ_CHUNK_SIZE, giving equal-priority tasks a scheduling
 * point during sustained bursts without blocking on a fresh RX notification.
 */
#define CDC_RX_FULL_READ_YIELD_THRESHOLD 8U
